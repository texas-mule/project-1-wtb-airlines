...
public class PilotCraft {

	public PilotCraft() {
		super();
	}

	public PilotCraft(Integer id, String name, String certs, Integer pilotCount, String url,
	...
	/**
	 * The unique integer that identifies the aircraft. (Required)
	 * 
	 */
	@JsonProperty("id")
	@JsonPropertyDescription("The unique integer that identifies the aircraft.")
	private Integer id;
	/**
	...
	/**
	 * The number of pilots from Flight School who are certified to fly this
	 * aircraft. (Required)
	 * 
	 */
	@JsonProperty("pilot_count")
	@JsonPropertyDescription("The number of pilots from Flight School who are certified to fly this aircraft.")
